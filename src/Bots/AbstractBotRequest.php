...
abstract class AbstractBotRequest
{
    ...
    {
        return [
            'сейчас', 'хорошо', 'тогда', 'блядь', 'слово', 'тупая', 'шлюха', 'дурак', 'дура', 'блин', 'ага', 'я', 'э', 'а'
        ];
    }
    ...
    {
        return [
            'давайте', 'сказала', 'сказал', 'говорю', 'ладно', 'давай', 'снова', 'тоже', 'сама', 'этот', 'было', 'была', 'был', 'это', 'эта', 'так', 'сам', 'вот', 'уже', 'дай', 'мне', 'ты', 'ой', 'да', 'ну', 'же', '-', '=', '?'
        ];
    }
