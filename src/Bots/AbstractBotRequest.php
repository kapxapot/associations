...
abstract class AbstractBotRequest
{
    ...
    {
        return [
            'использовалось', 'использовалась', 'использовался', 'проиграла', 'проиграл', 'повторяю', 'например', 'говоришь', 'говорила', 'наверное', 'наверно', 'говорим', 'говорил', 'начинаю', 'понятно', 'конечно', 'давайте', 'скажите', 'сказали', 'сказала', 'сказал', 'говорю', 'говори', 'твоего', 'охуела', 'почему', 'вообще', 'просто', 'кстати', 'короче', 'только', 'точнее', 'поняла', 'понял', 'какой', 'какая', 'какие', 'какое', 'такой', 'такая', 'такую', 'такие', 'таких', 'такое', 'ладно', 'давай', 'тогда', 'вдруг', 'зачем', 'очень', 'опять', 'охуел', 'нихуя', 'снова', 'разве', 'чтобы', 'скажу', 'нужно', 'можно', 'твоих', 'твоей', 'блять', 'могут', 'твои', 'твоё', 'твое', 'твой', 'твоя', 'тебе', 'тебя', 'себе', 'себя', 'меня', 'туда', 'куда', 'тоже', 'сама', 'этот', 'хочу', 'нету', 'епта', 'ёпта', 'надо', 'всем', 'всех', 'было', 'была', 'алло', 'тут', 'был', 'эти', 'это', 'эта', 'так', 'как', 'сам', 'вот', 'уже', 'дай', 'вам', 'мне', 'мои', 'мой', 'моя', 'мою', 'мое', 'моё', 'еще', 'ещё', 'нет', 'бля', 'епт', 'ёпт', 'все', 'всё', 'наш', 'нас', 'там', 'где', 'ней', 'нем', 'нём', 'них', 'его', 'ему', 'тот', 'они', 'опа', 'но', 'оп', 'он', 'мы', 'вы', 'то', 'та', 'те', 'ты', 'их', 'ой', 'ох', 'ух', 'ок', 'яй', 'ай', 'да', 'фу', 'ну', 'же', 'ее', 'её', 'ей', 'хм', 'ха', 'ах', 'эх', 'эй', 'я', 'э', 'а', '-', '=', '?'
        ];
    }
    ...
    {
        return [
            'здравствуйте', 'неправильно', 'естественно', 'ассоциация', 'здравствуй', 'пожалуйста', 'погромче', 'немножко', 'ёбанный', 'ёбанная', 'ёбанное', 'ёбанные', 'ебанный', 'ебанная', 'ебанное', 'ебанные', 'заебись', 'немного', 'сказать', 'чуточку', 'который', 'которая', 'которое', 'которые', 'проверь', 'ёбаный', 'ёбаная', 'ёбаное', 'ёбаные', 'ебаный', 'ебаная', 'ебаное', 'ебаные', 'пойдем', 'пойдём', 'сейчас', 'запиши', 'нельзя', 'хорошо', 'громче', 'потише', 'нахрен', 'теперь', 'помоги', 'пиздец', 'всякое', 'разное', 'значит', 'лучше', 'пусть', 'потом', 'точно', 'играю', 'пошли', 'блядь', 'люблю', 'слово', 'тупой', 'тупая', 'шлюха', 'еблан', 'дебил', 'дурак', 'дура', 'даже', 'тише', 'типа', 'блин', 'есть', 'хочу', 'твою', 'мать', 'ага', 'оно', 'она', 'что', 'че', 'чё', 'ты'
        ];
    }
