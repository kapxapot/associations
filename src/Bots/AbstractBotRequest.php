...
abstract class AbstractBotRequest
{
    ...
    {
        return [
            'пожалуйста', 'немножко', 'немного', 'который', 'которая', 'которое', 'которые', 'проверь', 'сейчас', 'запиши', 'нельзя', 'хорошо', 'потише', 'нахрен', 'теперь', 'пиздец', 'пусть', 'точно', 'играю', 'пошли', 'блядь', 'слово', 'тупая', 'шлюха', 'дурак', 'дура', 'тише', 'блин', 'есть', 'ага', 'оно', 'она'
        ];
    }
