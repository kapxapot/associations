...
abstract class AbstractBotRequest
{
    ...
    {
        return [
            'проверь', 'сейчас', 'хорошо', 'теперь', 'тогда', 'блядь', 'слово', 'тупая', 'шлюха', 'дурак', 'дура', 'блин', 'ага', 'я', 'э', 'а'
        ];
    }
    ...
    {
        return [
            'давайте', 'сказала', 'сказал', 'говорю', 'ладно', 'давай', 'снова', 'тоже', 'сама', 'этот', 'нету', 'было', 'была', 'был', 'это', 'эта', 'так', 'как', 'сам', 'вот', 'уже', 'дай', 'мне', 'еще', 'ещё', 'нет', 'ты', 'ой', 'ох', 'да', 'ну', 'же', 'хм', '-', '=', '?'
        ];
    }
