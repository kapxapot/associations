...
abstract class AbstractBotRequest
{
    ...
    {
        return [
            'проиграла', 'проиграл', 'повторяю', 'говорила', 'говорил', 'конечно', 'давайте', 'сказала', 'сказал', 'говорю', 'твоего', 'кстати', 'какой', 'какая', 'какие', 'какое', 'такой', 'такая', 'такие', 'такое', 'ладно', 'давай', 'тогда', 'вдруг', 'зачем', 'очень', 'снова', 'твоих', 'твои', 'твоё', 'твое', 'твой', 'твоя', 'тебе', 'тоже', 'сама', 'этот', 'хочу', 'нету', 'епта', 'ёпта', 'надо', 'всем', 'всех', 'было', 'была', 'был', 'эти', 'это', 'эта', 'так', 'как', 'сам', 'вот', 'уже', 'дай', 'мне', 'мои', 'мой', 'моя', 'мое', 'моё', 'еще', 'ещё', 'нет', 'бля', 'епт', 'ёпт', 'все', 'всё', 'где', 'ней', 'нем', 'нём', 'них','но', 'он', 'мы', 'вы', 'то', 'ты', 'их', 'ой', 'ох', 'ок', 'ай', 'да', 'ну', 'же', 'хм', '-', '=', '?'
        ];
    }
    ...
    {
        return [
            'пожалуйста', 'немножко', 'немного', 'который', 'которая', 'которое', 'которые', 'проверь', 'сейчас', 'запиши', 'хорошо', 'теперь', 'пошли', 'блядь', 'слово', 'тупая', 'шлюха', 'дурак', 'дура', 'блин', 'есть', 'ага', 'оно', 'она', 'я', 'э', 'а'
        ];
    }
