...
abstract class AbstractBotRequest
{
    ...
    {
        return [
            'конечно', 'давайте', 'сказала', 'сказал', 'говорю', 'твоего', 'кстати', 'какой', 'какая', 'какие', 'какое', 'ладно', 'давай', 'снова', 'твоих', 'твои', 'твоё', 'твое', 'твой', 'твоя', 'тебе', 'тоже', 'сама', 'этот', 'нету', 'было', 'была', 'был', 'это', 'эта', 'так', 'как', 'сам', 'вот', 'уже', 'дай', 'мне', 'мои', 'мой', 'моя', 'мое', 'моё', 'еще', 'ещё', 'нет', 'то', 'ты', 'ой', 'ох', 'да', 'ну', 'же', 'хм', '-', '=', '?'
        ];
    }
