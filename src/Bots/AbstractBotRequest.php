...
abstract class AbstractBotRequest
{
    ...
    {
        return [
            'пожалуйста', 'немножко', 'немного', 'который', 'которая', 'которое', 'которые', 'проверь', 'сейчас', 'запиши', 'нельзя', 'хорошо', 'потише', 'нахрен', 'теперь', 'пиздец', 'пусть', 'потом', 'точно', 'играю', 'пошли', 'блядь', 'слово', 'тупая', 'шлюха', 'дурак', 'дура', 'даже', 'тише', 'блин', 'есть', 'ага', 'оно', 'она'
        ];
    }
