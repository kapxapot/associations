...
abstract class AbstractBotRequest
{
    ...
    {
        return [
            'говорила', 'говорил', 'конечно', 'давайте', 'сказала', 'сказал', 'говорю', 'твоего', 'кстати', 'какой', 'какая', 'какие', 'какое', 'ладно', 'давай', 'снова', 'твоих', 'твои', 'твоё', 'твое', 'твой', 'твоя', 'тебе', 'тоже', 'сама', 'этот', 'нету', 'епта', 'ёпта', 'было', 'была', 'был', 'это', 'эта', 'так', 'как', 'сам', 'вот', 'уже', 'дай', 'мне', 'мои', 'мой', 'моя', 'мое', 'моё', 'еще', 'ещё', 'нет', 'бля', 'епт', 'ёпт', 'все', 'всё', 'то', 'ты', 'ой', 'ох', 'ок', 'ай', 'да', 'ну', 'же', 'хм', '-', '=', '?'
        ];
    }
