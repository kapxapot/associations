...
abstract class AbstractBotRequest
{
    ...
    {
        return [
            'здравствуйте', 'неправильно', 'естественно', 'ассоциация', 'здравствуй', 'пожалуйста', 'погромче', 'немножко', 'заебись', 'немного', 'сказать', 'чуточку', 'который', 'которая', 'которое', 'которые', 'проверь', 'пойдем', 'пойдём', 'сейчас', 'запиши', 'нельзя', 'хорошо', 'громче', 'потише', 'нахрен', 'теперь', 'помоги', 'пиздец', 'всякое', 'разное', 'значит', 'лучше', 'пусть', 'потом', 'точно', 'играю', 'пошли', 'блядь', 'люблю', 'слово', 'тупой', 'тупая', 'шлюха', 'еблан', 'дебил', 'дурак', 'дура', 'даже', 'тише', 'типа', 'блин', 'есть', 'хочу', 'ага', 'оно', 'она', 'что', 'че', 'чё', 'ты'
        ];
    }
