...
abstract class AbstractBotRequest
{
    ...
    {
        return [
            'проиграла', 'проиграл', 'повторяю', 'говоришь', 'говорила', 'говорил', 'конечно', 'давайте', 'сказала', 'сказал', 'говорю', 'говори', 'твоего', 'почему', 'кстати', 'точнее', 'какой', 'какая', 'какие', 'какое', 'такой', 'такая', 'такие', 'такое', 'ладно', 'давай', 'тогда', 'вдруг', 'зачем', 'очень', 'опять', 'снова', 'разве', 'нужно', 'твоих', 'твои', 'твоё', 'твое', 'твой', 'твоя', 'тебе', 'меня', 'тоже', 'сама', 'этот', 'хочу', 'нету', 'епта', 'ёпта', 'надо', 'всем', 'всех', 'было', 'была', 'алло', 'был', 'эти', 'это', 'эта', 'так', 'как', 'сам', 'вот', 'уже', 'дай', 'мне', 'мои', 'мой', 'моя', 'мое', 'моё', 'еще', 'ещё', 'нет', 'бля', 'епт', 'ёпт', 'все', 'всё', 'где', 'ней', 'нем', 'нём', 'них', 'тот', 'но', 'он', 'мы', 'вы', 'то', 'та', 'те', 'ты', 'их', 'ой', 'ох', 'ок', 'ай', 'да', 'ну', 'же', 'хм', 'я', 'э', 'а', '-', '=', '?'
        ];
    }
    ...
    {
        return [
            'пожалуйста', 'немножко', 'немного', 'который', 'которая', 'которое', 'которые', 'проверь', 'сейчас', 'запиши', 'нельзя', 'хорошо', 'потише', 'нахрен', 'теперь', 'пиздец', 'точно', 'играю', 'пошли', 'блядь', 'слово', 'тупая', 'шлюха', 'дурак', 'дура', 'тише', 'блин', 'есть', 'ага', 'оно', 'она'
        ];
    }
