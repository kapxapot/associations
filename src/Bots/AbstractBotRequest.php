...
abstract class AbstractBotRequest
{
    ...
    {
        return [
            'проиграла', 'проиграл', 'повторяю', 'например', 'говоришь', 'говорила', 'наверное', 'наверно', 'говорим', 'говорил', 'начинаю', 'конечно', 'давайте', 'скажите', 'сказала', 'сказал', 'говорю', 'говори', 'твоего', 'почему', 'вообще', 'кстати', 'точнее', 'какой', 'какая', 'какие', 'какое', 'такой', 'такая', 'такую', 'такие', 'такое', 'ладно', 'давай', 'тогда', 'вдруг', 'зачем', 'очень', 'опять', 'нихуя', 'снова', 'разве', 'чтобы', 'скажу', 'нужно', 'можно', 'твоих', 'твоей', 'блять', 'твои', 'твоё', 'твое', 'твой', 'твоя', 'тебе', 'тебя', 'себе', 'себя', 'меня', 'туда', 'куда', 'тоже', 'сама', 'этот', 'хочу', 'нету', 'епта', 'ёпта', 'надо', 'всем', 'всех', 'было', 'была', 'алло', 'тут', 'был', 'эти', 'это', 'эта', 'так', 'как', 'сам', 'вот', 'уже', 'дай', 'вам', 'мне', 'мои', 'мой', 'моя', 'мое', 'моё', 'еще', 'ещё', 'нет', 'бля', 'епт', 'ёпт', 'все', 'всё', 'наш', 'нас', 'там', 'где', 'ней', 'нем', 'нём', 'них', 'тот', 'они', 'но', 'он', 'мы', 'вы', 'то', 'та', 'те', 'ты', 'их', 'ой', 'ох', 'ок', 'яй', 'ай', 'да', 'фу', 'ну', 'же', 'ее', 'её', 'ей', 'хм', 'ха', 'ах', 'эх', 'эй', 'я', 'э', 'а', '-', '=', '?'
        ];
    }
